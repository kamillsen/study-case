  ...
  return (
    <footer className="mt-auto w-full border-t bg-[#F0F0F0] relative z-0 pt-20 md:pt-24">
      <div className="grid grid-cols-12 gap-10 px-10 pb-12 text-sm text-muted-foreground md:gap-12 md:px-12 md:pb-14">
        {/* Sol blok: logo + about + sosyal ikonlar */}
        <div className="col-span-12 space-y-6 md:col-span-4">
          ...
          <div className="flex items-center gap-3 text-foreground">
            <Link
              href="#"
              aria-label="Shop.co on Twitter"
              className="flex size-8 items-center justify-center rounded-full bg-white text-foreground hover:bg-white/90"
            >
              <Twitter className="size-4" />
            </Link>
            <Link
              href="#"
              aria-label="Shop.co on Facebook"
              className="flex size-8 items-center justify-center rounded-full bg-white text-foreground hover:bg-white/90"
            >
            ...
            <Link
              href="#"
              aria-label="Shop.co on Instagram"
              className="flex size-8 items-center justify-center rounded-full bg-white text-foreground hover:bg-white/90"
            >
        ...
        {/* Orta sütunlar: Company, Help, FAQ, Resources */}
        <div className="col-span-12 grid grid-cols-2 gap-8 text-xs md:col-span-8 md:grid-cols-4 md:text-sm">
          <div>
            <h3 className="mb-3 text-xs font-semibold uppercase tracking-wide text-foreground md:text-sm">
              Company
            </h3>
